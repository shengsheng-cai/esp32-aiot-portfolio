# MobileNetSSD 人物偵測 + face_recognition 人臉辨識 + 追蹤 + 錄影 + 掃描
# 對應原始：stranger.py（myI2C → mySerial，/dev/video? → VideoCapture(0)）
# 需要模型：MobileNetSSD_deploy.prototxt + MobileNetSSD_deploy.caffemodel
# 下載：https://github.com/chuanqi305/MobileNet-SSD
# 人臉圖片：img/Co-p.jpg, img/chinese.jpg, img/english.jpg
