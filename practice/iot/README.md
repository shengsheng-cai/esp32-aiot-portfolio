...
| 專案 | 說明 | 驗證狀態 |
|------|------|----------|
| [esp32-module-lib](esp32-module-lib/) | 45 種 ESP32 MicroPython 模組範例：感測器 · 通訊 · 控制 · 介面 · 進階整合；`keypad_dht11`（Keypad + DHT11 + Web）、`motor_console`（Relay + Servo + LED + Stepper）已實機驗證 | ✅ 部分實機驗證 |
