...
各子專案為職訓期間學習實作整理，程式邏輯已核對；`esp32-module-lib/advanced/keypad_dht11.py` 已在 ESP32-D0WD-V3 rev3.1 實機驗證通過，其餘 IoT 韌體驗證狀態詳見各自 README。
...
| 專案 | 說明 | 技術 |
|------|------|------|
| [esp32-module-lib](practice/iot/esp32-module-lib/) | 45 種 ESP32 MicroPython 模組範例：感測器 · 通訊 · 控制 · 介面 · 進階整合，含難度分級；`keypad_dht11` 已實機驗證 ✅ | MicroPython · MQTT · BLE · OTA · I2C · SPI |
